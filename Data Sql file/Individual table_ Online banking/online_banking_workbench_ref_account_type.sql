...
CREATE TABLE `ref_account_type` (
  `Accont_type_code` int(11) NOT NULL,
  `Accont_type_discription` varchar(20) NOT NULL,
  `Accont_type_current` int(11) NOT NULL,
  `Accont_type_deposit` int(11) NOT NULL,
  PRIMARY KEY (`Accont_type_code`)
